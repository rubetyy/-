...
public class LiveController {
	...
	@ApiOperation(value = "방송시작", notes = "방송시작 정보 반환합니다.")
	@ApiResponses({
	...
	public ResponseEntity register(
			@RequestBody @ApiParam(value="방송시작정보반환", required = true) LiveRegisterPostReq registerInfo) {
	...
	public ResponseEntity selectOne(
			@RequestBody @ApiParam(value="방송id",required = true) @PathVariable String liveid
	) {

		//임의로 리턴된 User 인스턴스. 현재 코드는 회원 가입 성공 여부만 판단하기 때문에 굳이 Insert 된 유저 정보를 응답하지 않음.
		Optional<Live> live = liveService.selectOne(Long.valueOf(liveid));
